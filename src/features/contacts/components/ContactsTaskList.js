...
const ContactsTaskList = () => {
    const [contactsTasksFilters, setContactsTasksFilters] = useState({
    ...
    const [contactsTasks, setContactsTasks] = useState([
        {
            id: 1,
            type: "Call",
            sub_type: "Follow-Up",
            start_date_time: "10-02-2025 11:00 AM",
            priority: "High",
            subject: "Contact Follow-Up",
            status: "In Progress",
            contact_name: "Aditya Sharma",
            company: "Infosys",
            phone: "+91 98765 43210",
            email: "aditya.sharma@infosys.com",
        ...
        },
        {
            ...
            type: "Meeting",
            sub_type: "Discussion",
            start_date_time: "15-02-2025 03:00 PM",
            priority: "Medium",
        ...
        },
        {
            ...
            type: "Call",
            sub_type: "Follow-Up",
            start_date_time: "18-02-2025 10:00 AM",
            priority: "High",
            ...
            edit_date: "09-02-2025",
            created_by: "Admin",
        },
        {
            id: 4,
            type: "Meeting",
            sub_type: "Brainstorming",
            start_date_time: "20-02-2025 01:00 PM",
            priority: "Low",
            subject: "New Marketing Ideas",
            status: "Scheduled",
            contact_name: "Anjali Mehta",
            company: "Tech Mahindra",
            phone: "+91 65432 10987",
            email: "anjali.mehta@techmahindra.com",
            categories: "Marketing",
            groups: "Marketing Team",
            create_date: "07-02-2025",
            edit_date: "10-02-2025",
        ...
        },
        {
            ...
            start_date_time: "25-02-2025 11:30 AM",
            priority: "Medium",
            subject: "Client Onboarding",
            status: "Completed",
            contact_name: "Vikram Reddy",
            company: "HCL Technologies",
            phone: "+91 54321 09876",
            email: "vikram.reddy@hcltech.com",
            categories: "Client Relations",
            groups: "Support Team",
            create_date: "08-02-2025",
            edit_date: "11-02-2025",
        ...
        },
        {
            ...
            type: "Meeting",
            sub_type: "Review",
            start_date_time: "22-02-2025 09:00 AM",
            priority: "High",
            ...
            email: "priya.iyer@cognizant.com",
            categories: "Reports",
            groups: "Executive Team",
            create_date: "09-02-2025",
            edit_date: "12-02-2025",
            created_by: "CEO",
        },
        {
            id: 7,
            type: "Call",
            sub_type: "Check-in",
            start_date_time: "19-02-2025 02:00 PM",
            priority: "Medium",
            ...
            email: "arjun.malhotra@ril.com",
            categories: "Sustainability",
            groups: "Environmental Team",
            create_date: "10-02-2025",
            edit_date: "13-02-2025",
            created_by: "Coordinator",
        },
        {
            id: 8,
            type: "Meeting",
            sub_type: "Planning",
            start_date_time: "24-02-2025 03:30 PM",
            priority: "High",
            ...
            email: "neha.gupta@zoho.com",
            categories: "Strategy",
            groups: "Product Team",
            create_date: "11-02-2025",
            edit_date: "14-02-2025",
        ...
        },
        {
            ...
            type: "Call",
            sub_type: "Follow-Up",
            start_date_time: "28-02-2025 04:00 PM",
            priority: "Low",
            ...
            email: "suresh.kumar@mindtree.com",
            categories: "Feedback",
            groups: "Sales Team",
            create_date: "12-02-2025",
            edit_date: "15-02-2025",
        ...
        },
        {
            ...
            type: "Meeting",
            sub_type: "Wrap-Up",
            start_date_time: "27-02-2025 02:15 PM",
            priority: "Medium",
            ...
            email: "divya.reddy@lntinfotech.com",
            categories: "Management",
            groups: "Project Team",
            create_date: "13-02-2025",
            edit_date: "16-02-2025",
        ...
        },
        {
            ...
            type: "Call",
            sub_type: "Follow-Up",
            start_date_time: "26-02-2025 10:00 AM",
            priority: "High",
            ...
            email: "karthik.nair@hdfcbank.com",
            categories: "Finance",
            groups: "Finance Team",
            create_date: "14-02-2025",
            edit_date: "17-02-2025",
    ...
    const deleteContact = (contact) => {
        let _contacts = [...contactsTasks];
        _contacts = _contacts.filter((c) => c.id !== contact.id);
        setContactsTasks(_contacts); // Update the contact data state
    ...
    const handleClearSearchContactsTasklist = () => {
        setContactsTasksFilters({
            type: { value: " " },
            sub_type: { value: " " },
                        ...
                        <Row className="justify-content-between ac-items">
                            <Col xxl={9} xl={12} lg={12} md={12} sm={12}>
                                ...
                                <span className="icons-ac">
                                    {selectedContactsTasks.length > 0 ?
                                        ...
                                        <span className="action-icons me-2">
                                            ...
                                            >
                                                <i className="pi pi-user-plus"></i> {selectedContactsTasks.length} Selected
                                            </button>
                            ...
                            <Col xxl={3} xl={12} lg={12} sm={12}>
                                <div className="clr-icons">
                                    {selectedContactsTasks.length > 0 ? <NotesContact1 /> : <NotesContact />}

                                    <Export />

                                    <button
                                        type="button"
                                        className="btn btn-secondary icons-btn me-1" Tooltip="Clear Search" onClick={handleClearSearchContactsTasklist}
                                    >
                            ...
                            <Col lg={12}>
                                ...
                                <div className="card1 mt-4 mb-4 actjobsumtable">
                                    <DataTable
                                        ...
                                        emptyMessage="No contacts tasks found."
                                        selection={selectedContactsTasks}
                                        onSelectionChange={(e) => setSelectedContactsTasks(e.value)}
                                    ...
                                    >
                                        ...
                                        <Column field="type" header="Type" sortable frozen filter style={{ minWidth: "10rem" }} />
...
export default ContactsTaskList;
