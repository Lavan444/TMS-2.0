...
const ContactsDuplicate = () => {
    ...
    // datatable starts
    const [contactsDuplicateFilters, setContactsDuplicateFilters] = useState({
        ...
        primary_skills: { value: null, matchMode: FilterMatchMode.STARTS_WITH },
    ...
    const [contactsDuplicate, setContactsDuplicate] = useState([
        {
            id: 1,
            first_name: "Rahul",
            last_name: "Sharma",
        ...
        },
        {
            ...
            mobile_phone: "8345678901",
            company: "Infosys",
            job_title: "Product Manager",
            primary_skills: "Leadership, Planning",
            city: "Bengaluru",
            categories: "Management",
            groups: "Planning",
            create_date: "05-02-2025",
            edit_date: "08-02-2025",
            created_by: "Manager",
        },
        {
            id: 3,
        ...
        },
        {
            ...
            email: "anjali.gupta@wipro.com",
            mobile_phone: "7567890123",
            company: "Wipro",
            job_title: "Data Scientist",
            primary_skills: "Data Analysis, Machine Learning",
            city: "Pune",
            categories: "Analytics",
            groups: "Research",
            create_date: "07-02-2025",
            edit_date: "08-02-2025",
            created_by: "VP",
        },
        {
            ...
            email: "vikram.patel@hcltech.com",
            mobile_phone: "8678901234",
            company: "HCL Technologies",
            job_title: "UX Designer",
            primary_skills: "UI/UX, Adobe XD",
            city: "Chennai",
            categories: "Design",
            groups: "Creative",
            create_date: "03-02-2025",
            edit_date: "08-02-2025",
            created_by: "Senior Designer",
        },
        {
            id: 7,
            first_name: "Neha",
            last_name: "Reddy",
            website: "www.techmahindra.com",
            email: "neha.reddy@techmahindra.com",
            mobile_phone: "9789012345",
            company: "Tech Mahindra",
            job_title: "Marketing Lead",
            primary_skills: "Strategy, Content Creation",
            city: "Hyderabad",
        ...
        },
        {
            ...
            last_name: "Kapoor",
            website: "www.infosys.com",
            email: "arjun.kapoor@infosys.com",
            mobile_phone: "8890123456",
            company: "Infosys",
            job_title: "Sales Manager",
            primary_skills: "Negotiation, Client Relations",
            city: "Kolkata",
            categories: "Sales",
            groups: "Growth",
        ...
        },
        {
            ...
            last_name: "Desai",
            website: "www.tcs.com",
            email: "sneha.desai@tcs.com",
            mobile_phone: "8901234567",
            company: "Tata Consultancy Services",
            job_title: "Graphic Designer",
            primary_skills: "Branding, Illustrator",
            city: "Ahmedabad",
            categories: "Design",
            groups: "Branding",
        ...
        },
        {
            ...
            primary_skills: "Business Analysis, Process Improvement",
            city: "Noida",
            categories: "Consulting",
            groups: "Strategy",
            create_date: "03-02-2025",
            edit_date: "08-02-2025",
            created_by: "Consulting Lead",
        },
        {
            id: 11,
            first_name: "Kavita",
            last_name: "Joshi",
            website: "www.hcltech.com",
            email: "kavita.joshi@hcltech.com",
            mobile_phone: "7123456789",
            company: "HCL Technologies",
            job_title: "Product Designer",
            primary_skills: "E-commerce, Product Design",
            city: "Lucknow",
            categories: "Design",
            groups: "Product",
            create_date: "07-02-2025",
    ...
    const [selectedContactsDuplicate, setSelectedContactsDuplicate] = useState([]);
    ...
    const deleteContact = (contact) => {
        let _contacts = [...contactsDuplicate];
        _contacts = _contacts.filter((c) => c.id !== contact.id);
        setContactsDuplicate(_contacts); // Update the contact data state
        toast.current.show({ severity: 'error', summary: 'Duplicate contact deleted', detail: `${contact.firstName} ${contact.lastName}` });
    };
    // view starts
    ...
    const handleClearSearchContactsDuplicate = () => {
        setContactsDuplicateFilters({
            first_name: { value: " " },
            last_name: { value: " " },
            website: { value: " " },
            email: { value: " " },
                        ...
                        <Row className="justify-content-between ac-items">
                            <Col xxl={9} xl={12} lg={12} md={12} sm={12}>
                                ...
                                <span className="icons-ac">
                                    {selectedContactsDuplicate.length > 0 ?
                                        ...
                                        <span className="action-icons me-2">
                                            ...
                                            >
                                                <i className="pi pi-user-plus"></i> {selectedContactsDuplicate.length} Selected
                                            </button>
                            ...
                            <Col xxl={3} xl={12} lg={12} sm={12}>
                                <div className="clr-icons">
                                    {selectedContactsDuplicate.length > 0 ? <NotesContact1 /> : <NotesContact />}

                                    <Export />

                                    <button
                                        type="button"
                                        className="btn btn-secondary icons-btn me-1" Tooltip="Clear Search" onClick={handleClearSearchContactsDuplicate}
                                    >
                            ...
                            <Col lg={12}>
                                ...
                                <div className="card1 mt-4 mb-4 actjobsumtable">
                                    <DataTable
                                        ...
                                        filters={contactsDuplicateFilters}
                                        filterDisplay="row"
                                        globalFilterFields={[
                                            "first_name",
                                            "last_name",
                                        ...
                                        emptyMessage="No duplicate contacts found."
                                        selection={selectedContactsDuplicate}
                                        onSelectionChange={(e) => setSelectedContactsDuplicate(e.value)}
                                    ...
                                    >
                                        ...
                                        <Column field="first_name" header="First Name" sortable filter style={{ minWidth: "12rem" }} />
                                        <Column field="last_name" header="Last Name" sortable filter style={{ minWidth: "12rem" }} />
                                        <Column field="website" header="Website" sortable filter style={{ minWidth: "12rem" }} />
                                        ...
                                        <Column field="city" header="City" sortable filter style={{ minWidth: "12rem" }} />
...
export default ContactsDuplicate;
