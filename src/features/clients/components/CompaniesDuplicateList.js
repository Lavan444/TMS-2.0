...
const CompaniesDuplicateList = () => {
  ...
  const [filters, setFilters] = useState({
    ...
    primarySkills: { value: null, matchMode: FilterMatchMode.CONTAINS },
  ...
  const [companyData, setCompanyData] = useState([
    ...
    },
    {
      ...
      primarySkills: "Agile, UX, Marketing",
      city: "Bengaluru",
      categories: "Sales",
      groups: "Team B",
    ...
    },
    {
      ...
      firstName: "Anjali",
      lastName: "Gupta",
      website: "https://anjaligupta.com",
      email: "anjali.gupta@example.com",
      mobilePhone: "5671230987",
      company: "Tata Consultancy Services",
      jobTitle: "Data Scientist",
      primarySkills: "Python, Machine Learning, AI",
      city: "Delhi",
      categories: "Research",
      groups: "Team C",
    ...
    },
    {
      ...
      firstName: "Vikram",
      lastName: "Patel",
      website: "https://vikrampatel.com",
      email: "vikram.patel@example.com",
      mobilePhone: "6789012345",
      company: "Wipro",
      jobTitle: "Financial Analyst",
      primarySkills: "Finance, Excel, Risk Analysis",
      city: "Chennai",
      categories: "Finance",
      groups: "Team D",
    ...
    },
    {
      ...
      firstName: "Neha",
      lastName: "Reddy",
      website: "https://nehareddy.com",
      email: "neha.reddy@example.com",
      mobilePhone: "3456789012",
      company: "HDFC Bank",
      jobTitle: "Medical Researcher",
      primarySkills: "Biotech, Pharma, Data Science",
      city: "Hyderabad",
    ...
    },
    {
      ...
      primarySkills: "Networking, Security, Encryption",
      city: "Pune",
    ...
    },
    {
      ...
      firstName: "Sneha",
      lastName: "Desai",
      website: "https://snehadesai.com",
      email: "sneha.desai@example.com",
      mobilePhone: "7890123456",
      company: "Tech Mahindra",
      jobTitle: "Environmental Scientist",
      primarySkills: "Sustainability, Renewable Energy",
      city: "Ahmedabad",
      categories: "Environment",
      groups: "Team G",
      createDate: "30-01-2025",
      editDate: "28-02-2025",
      createdBy: "Manager",
    },
    {
      ...
      primarySkills: "Solidity, Ethereum, Web3",
      city: "Kolkata",
    ...
    },
    {
      ...
      firstName: "Kavita",
      lastName: "Joshi",
      website: "https://kavitajoshi.com",
      email: "kavita.joshi@example.com",
      mobilePhone: "2345678901",
      company: "Bajaj Finserv",
      jobTitle: "Education Specialist",
      primarySkills: "E-learning, Instructional Design",
      city: "Jaipur",
    ...
    },
    {
      ...
      firstName: "Ravi",
      lastName: "Verma",
      website: "https://raviverma.com",
      email: "ravi.verma@example.com",
      mobilePhone: "8012345678",
      company: "Tech Mahindra",
      jobTitle: "Cybersecurity Engineer",
      primarySkills: "Networking, Security, Encryption",
      city: "Nagpur",
                ...
                <section className="allactjobs-table">
                  ...
                  <div className="card1 mt-4 mb-4 actjobsumtable">
                    ...
                    >
                      ...
                      <Column field="website" header="Website" sortable filter />
                      <Column field="email" header="Email" sortable filter />
                      <Column field="mobilePhone" header="Mobile Phone" sortable filter />
                      <Column field="jobTitle" header="Job Title" sortable filter />
                      <Column field="primarySkills" header="Primary Skills" sortable filter />
                      <Column field="city" header="City" sortable filter />
                      <Column field="categories" header="Categories" sortable filter />
                      <Column field="groups" header="Groups" sortable filter />
                      <Column field="createDate" header="Create Date" sortable filter />
                      <Column field="editDate" header="Edit Date" sortable filter />
                      <Column field="createdBy" header="Created By" sortable filter />
                    </DataTable>
...
export default CompaniesDuplicateList
