...
const ImportFromCSVJobs = () => {
    ...
    const [mappingFields, setMappingFields] = useState([
        { atsField: 'Job ID', defaultValue: '' },
        { atsField: 'Hiring Manager', defaultValue: '' },
        { atsField: 'Job Title', defaultValue: '' },
        { atsField: 'Department', defaultValue: '' },
        { atsField: 'Location', defaultValue: '' }
    ]);

    const csvColumnOptions = [
        { label: 'Job ID', value: 'First name' },
        { label: 'Job Title', value: 'Middle name' },
                                                    ...
                                                    <Col md={12}>
                                                        ...
                                                        <div className="card p-3">
                                                            ...
                                                            <div className="mb-3 dup-check">
                                                                <label className="mb-2 import-head">Please choose an action to take if a duplicate job is detected during the upload.</label>
                                                                <div className="mt-2">
                                                                    <div>
                                                                        <input type="radio" id="add_as_a_resume" name="category" value="add_as_a_resume" />
                                                                        <label htmlFor="add_as_a_resume" className="ms-2 mb-0 import-fw">Add as a Jobs
                                                                        </label>
                                                                        <p className="txt">Select this option to create a new jobs in the system.
                                                                        </p>
                                                                    </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p className="txt">Choose this option to replace the existing jobs with the new one.</p>
                                                                    </div>
...
export default ImportFromCSVJobs;