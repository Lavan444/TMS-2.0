...
const JobActivityLog = () => {
    ...
    const [filters, setFilters] = useState({
        ...
        job_type: { value: null, matchMode: 'contains' },
        job_status: { value: null, matchMode: 'contains' },
        job_title: { value: null, matchMode: 'contains' },
        hiring_manager: { value: null, matchMode: 'contains' },
    ...
    const [jobsData, setJobsData] = useState([
        ...
        },
        {
            ...
            hiring_manager: "Aarav Shah",
            company: "Finance Solutions India",
            department: "Finance",
            category: "Internship",
            group: "Finance Team",
            create_date: "05-02-2025",
