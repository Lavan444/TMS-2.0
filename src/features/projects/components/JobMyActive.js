                                    ...
                                    <div className="card sidebardetails">
                                        ...
                                        <form>
                                            ...
                                            <Row className="mb-3">
                                                <Col lg={12}>
                                                    <div className="">
                                                        <Editor value={text} onTextChange={(e) => setText(e.htmlValue)} headerTemplate={renderHeader()} style={{ height: '140px' }} />
                                                    </div>
                                                </Col>
                                            </Row>
