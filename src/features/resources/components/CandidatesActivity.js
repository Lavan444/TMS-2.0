...
const CandidatesActivityLog = () => {

    // Datatable fields

    const [candidatesActivityFilters, setCandidatesActivityFilters] = useState({
        global: { value: null, matchMode: FilterMatchMode.CONTAINS },
        type: { value: null, matchMode: FilterMatchMode.STARTS_WITH },
        sub_type: { value: null, matchMode: FilterMatchMode.STARTS_WITH },
        start_date_time: { value: null, matchMode: FilterMatchMode.DATE_IS },
    ...
    const [candidatesActivity, setCandidatesActivity] = useState([
        {
            type: "Interview",
            sub_type: "Technical",
            start_date_time: "10-02-2025 10:00",
            priority: "High",
        ...
        {
            type: "Call",
            sub_type: "Initial Screening",
            start_date_time: "12-02-2025 14:00",
            priority: "Medium",
            subject: "Initial Screening Call",
            status: "Scheduled",
            full_name: "Bharat Sharma",
            company_name: "Creative Agency",
            job_title: "UI/UX Designer",
            phone: "+91 98765 43210",
            categories: "Design",
            groups: "Design Team",
            create_date: "03-02-2025",
            edit_date: "06-02-2025",
            created_by: "Manager",
        },
        {
            "type": "Call",
            "sub_type": "Initial Screening",
            "start_date_time": "14-02-2025 11:00",
            "priority": "Medium",
            "subject": "Initial Interview Call",
            "status": "Scheduled",
        ...
        },
        {
            "type": "Call",
            "sub_type": "Initial Screening",
            "start_date_time": "13-02-2025 16:00",
            "priority": "High",
            "subject": "Initial Screening for Marketing Role",
            "status": "Scheduled",
            "full_name": "Tanvi Malhotra",
        ...
        },
        {
            "type": "Call",
            "sub_type": "Initial Screening",
            "start_date_time": "15-02-2025 09:00",
            "priority": "Medium",
            "subject": "Initial Screening for Developer Role",
            "status": "Scheduled",
            "full_name": "Sarika Bansal",
        ...
        },
        {
            "type": "Call",
            "sub_type": "Initial Screening",
            "start_date_time": "16-02-2025 13:30",
            "priority": "Medium",
            "subject": "Initial Screening for IT Support",
            "status": "Scheduled",
            "full_name": "Jai Deshmukh",
        ...
        },
        {
            "type": "Call",
            "sub_type": "Initial Screening",
            "start_date_time": "17-02-2025 10:00",
            "priority": "Low",
            "subject": "Initial Screening for HR Assistant",
            "status": "Scheduled",
            "full_name": "Eesha Trivedi",
        ...
        },
        {
            "type": "Call",
            "sub_type": "Initial Screening",
            "start_date_time": "18-02-2025 15:00",
            "priority": "High",
            "subject": "Initial Screening for Project Manager",
            "status": "Scheduled",
            "full_name": "Dhruv Verma",
            "company_name": "CloudTech",
        ...
        },
        {
            "type": "Call",
            "sub_type": "Initial Screening",
            "start_date_time": "19-02-2025 11:30",
            "priority": "Medium",
            "subject": "Initial Screening for Content Writer",
            "status": "Scheduled",
            "full_name": "Charu Sengupta",
        ...
        },
        {
            "type": "Call",
            "sub_type": "Initial Screening",
            "start_date_time": "20-02-2025 14:45",
            "priority": "High",
            "subject": "Initial Screening for Business Analyst",
            "status": "Scheduled",
            "full_name": "Ojaswi Mehta",
            "company_name": "Global Ventures",
            "job_title": "Business Analyst",
            "phone": "+91 10987 65432",
            "categories": "Analysis",
            "groups": "Business Team",
            "create_date": "03-02-2025",
            "edit_date": "06-02-2025",
            "created_by": "Manager"
        },
        {
            "type": "Call",
            "sub_type": "Initial Screening",
            "start_date_time": "21-02-2025 09:30",
            "priority": "Medium",
            "subject": "Initial Screening for Sales Executive",
            "status": "Scheduled",
            "full_name": "Eshan Agarwal",
            "company_name": "Creative Agency",
    ...
    const [selectedCandidatesActivity, setSelectedCandidatesActivity] = useState([]);
    ...
    const deleteCandidate = (candidate) => {
        let _candidates = [...candidatesActivity];
        _candidates = _candidates.filter((c) => c.id !== candidate.id);
        setCandidatesActivity(_candidates); // Update the candidate data state
    ...
    const handleClearSearchActivity = () => {
        setCandidatesActivityFilters({
            type: { value: " " },
            sub_type: { value: " " },
                        ...
                        <Row className="justify-content-between ac-items">
                            <Col xxl={9} xl={12} lg={12} md={12} sm={12}>
                                <span className="addcan-ac">
                                    ...
                                    {selectedCandidatesActivity.length > 0 ?
                                        ...
                                        <span className="action-icons me-2">
                                            ...
                                            >
                                                <i className="pi pi-user"></i> {selectedCandidatesActivity.length} Selected
                                            </button>
                            ...
                            <Col xxl={3} xl={12} lg={12} sm={12}>
                                <div className="clr-icons">
                                    {selectedCandidatesActivity.length > 0 ? <NotesCandidate /> : <Notes />}
                                    ...
                                    <button
                                        type="button"
                                        className="btn btn-secondary icons-btn" Tooltip="Clear Search" onClick={handleClearSearchActivity}
                                    >
                            ...
                            <Col lg={12}>
                                ...
                                <div className="card1 mt-4 mb-4 actjobsumtable">
                                    <DataTable
                                        ...
                                        filters={candidatesActivityFilters}
                                        filterDisplay="row"
                                        globalFilterFields={[
                                            "type",
                                            "sub_type",
                                        ...
                                        emptyMessage="No candidates activity found."
                                        selection={selectedCandidatesActivity}
                                        onSelectionChange={(e) => setSelectedCandidatesActivity(e.value)}
                                    ...
                                    >
                                        ...
                                        <Column field="start_date_time" header="Start Date Time" sortable filter style={{ minWidth: "12rem" }} />
                                        ...
                                        <Column field="full_name" header="Full Name" sortable filter style={{ minWidth: "12rem" }} />
                                        <Column field="company_name" header="Company Name" sortable filter style={{ minWidth: "12rem" }} />
                                        <Column field="job_title" header="Job Title" sortable filter style={{ minWidth: "12rem" }} />
                                        <Column field="phone" header="Phone" sortable filter style={{ minWidth: "12rem" }} />
...
export default CandidatesActivityLog;
