...
const CandidatesAddedbyme = () => {
    ...
    const [candidatesAddedByMe, setCandidatesAddedByMe] = useState([
        {
            id: 1, // Unique ID
            first_name: "Rahul",
            last_name: "Sharma",
            ...
            email_primary: "rahul.sharma@techmahindra.com",
            mobile_phone: "1234567890",
            city: "Mumbai",
            status: "Active",
            employee_type: "Full-Time",
            relocation: "No",
            availability_date: "20-02-2025", // dd-mm-yyyy
            categories: "Development",
            groups: "Frontend Team",
            create_date: "01-02-2025", // dd-mm-yyyy
        ...
        },
        {
            ...
            primary_skills: "Figma, Sketch",
            email_primary: "priya.singh@infosys.com",
            ...
            categories: "Design",
            groups: "Design Team",
            create_date: "03-02-2025", // dd-mm-yyyy
        ...
        },
        {
            ...
            email_primary: "vikram.patel@wipro.com",
            mobile_phone: "8765432109",
            city: "Pune",
            status: "Active",
            employee_type: "Full-Time",
            relocation: "No",
            availability_date: "15-02-2025", // dd-mm-yyyy
            categories: "Development",
            groups: "Frontend Team",
            create_date: "03-02-2025", // dd-mm-yyyy
            edit_date: "06-02-2025", // dd-mm-yyyy
        ...
        },
        {
            ...
            primary_skills: "AWS, Azure",
            email_primary: "anjali.gupta@tcs.com",
        ...
        },
        {
            ...
            primary_skills: "SEO, Content Strategy",
            email_primary: "neha.reddy@hcl.com",
            mobile_phone: "6543210987",
            city: "Chennai",
            status: "Active",
        ...
        },
        {
            ...
            email_primary: "arjun.kapoor@techmahindra.com",
            mobile_phone: "5432109876",
            city: "Noida",
            status: "On Hold",
            employee_type: "Contract",
            relocation: "Yes",
        ...
        },
        {
            ...
            primary_skills: "Recruitment, Employee Relations",
            email_primary: "sneha.desai@infosys.com",
            mobile_phone: "4321098765",
            city: "Ahmedabad",
            status: "Active",
            employee_type: "Full-Time",
            relocation: "No",
            availability_date: "12-02-2025", // dd-mm-yyyy
        ...
        },
        {
            ...
            email_primary: "rajesh.kumar@wipro.com",
            mobile_phone: "3210987654",
            city: "Kolkata",
            status: "Pending",
            employee_type: "Contract",
            relocation: "Yes",
            availability_date: "05-03-2025", // dd-mm-yyyy
        ...
        },
        {
            ...
            primary_skills: "Process Improvement, SQL",
            email_primary: "kavita.joshi@hcl.com",
            mobile_phone: "2109876543",
            city: "Lucknow",
            status: "Active",
            employee_type: "Full-Time",
            relocation: "No",
            availability_date: "18-02-2025", // dd-mm-yyyy
            categories: "Analysis",
        ...
        },
        {
            ...
            email_primary: "sanjay.mehta@techmahindra.com",
            mobile_phone: "1098765432",
            city: "Jaipur",
            status: "On Hold",
            employee_type: "Contract",
            relocation: "Yes",
            availability_date: "12-03-2025", // dd-mm-yyyy
            categories: "Design",
    ...
    const [selectedCandidatesAddedByMe, setSelectedCandidatesAddedByMe] = useState([]);
    ...
    const deleteCandidate = (candidate) => {
        let _candidates = [...candidatesAddedByMe];
        _candidates = _candidates.filter((c) => c.id !== candidate.id);
        setCandidatesAddedByMe(_candidates); // Update the candidate data state
    ...
    const handleClearSearchTaskList = () => {
                        ...
                        <Row className="justify-content-between ac-items">
                            <Col xxl={9} xl={12} lg={12} md={12} sm={12}>
                                <span className="addcan-ac">
                                    ...
                                    {selectedCandidatesAddedByMe.length > 0 ?
                                        ...
                                        <span className="action-icons me-2">
                                            ...
                                            >
                                                <i className="pi pi-user"></i> {selectedCandidatesAddedByMe.length} Selected
                                            </button>
                            ...
                            <Col xxl={3} xl={12} lg={12} sm={12}>
                                <div className="clr-icons">
                                    {selectedCandidatesAddedByMe.length > 0 ? <NotesCandidate /> : <Notes />}
                                    ...
                                    <button
                                        type="button"
                                        className="btn btn-secondary icons-btn" Tooltip="Clear Search" onClick={handleClearSearchTaskList}
                                    >
                            ...
                            <Col lg={12}>
                                ...
                                <div className="card1 mt-4 mb-4 actjobsumtable">
                                    <DataTable
                                        ...
                                        emptyMessage="No candidates added by me found."
                                        selection={selectedCandidatesAddedByMe}
                                        onSelectionChange={(e) => setSelectedCandidatesAddedByMe(e.value)}
...
export default CandidatesAddedbyme;
