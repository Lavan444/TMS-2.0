...
const OutBox = () => {
  ...
  const [filters, setFilters] = useState({
    ...
    mailType: { value: null, matchMode: FilterMatchMode.CONTAINS },
  ...
  const [tableData, setTableData] = useState([
    {
      id: 1,
      fromName: 'Srinivas',
      toDisplayName: 'Rajesh Kumar',
      email: 'rajesh.kumar@indianats.com',
      mailType: 'Mail',
      subject: 'Capterra - Before We Get Started',
      date: '21/01/2025 12:00:05 AM',
      userId: 'Harish',
      private: false,
    },
    {
      ...
      email: 'priya.sharma@indianats.com',
    ...
    {
      id: 3,
      fromName: 'Naveen Kumar',
      toDisplayName: 'Vikram Singh',
      email: 'vikram.singh@indianats.com',
      mailType: 'Mail',
    ...
    {
      id: 4,
      fromName: 'Ravi Shankar',
      toDisplayName: 'Ananya Reddy',
      email: 'ananya.reddy@indianats.com',
      mailType: 'Notification',
    ...
    },
    {
      ...
      toDisplayName: 'Arjun Patel',
      email: 'arjun.patel@indianats.com',
      mailType: 'Alert',
    ...
    {
      id: 6,
      fromName: 'Manoj Verma',
      toDisplayName: 'Divya Nair',
      email: 'divya.nair@indianats.com',
      mailType: 'Mail',
    ...
    },
    {
      id: 7,
      fromName: 'Deepa Nair',
      toDisplayName: 'Rahul Iyer',
      email: 'rahul.iyer@indianats.com',
      mailType: 'Mail',
    ...
    {
      id: 8,
      fromName: 'Karan Gupta',
      toDisplayName: 'Neha Kapoor',
      email: 'neha.kapoor@indianats.com',
      mailType: 'Alert',
    ...
    },
    {
      id: 9,
      fromName: 'Sneha Rao',
      toDisplayName: 'Sanjay Joshi',
      email: 'sanjay.joshi@indianats.com',
      mailType: 'Notification',
    ...
    },
    {
      ...
      toDisplayName: 'Pooja Desai',
      email: 'pooja.desai@indianats.com',
      mailType: 'Mail',
  ...
  return (
    <React.Fragment>
      <div className="page-content allact-tabs outbox">
              ...
              <Col md={6} lg={6} className="d-flex align-items-center">
                ...
                <div>
                  <button
                    ...
                    onClick={handleClearSearchOutBox}
                  >
