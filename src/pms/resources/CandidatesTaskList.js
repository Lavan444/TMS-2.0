...
const CandidatesTaskList = () => {

    // Datatable fields

    const [candidateTasksFilters, setCandidateTasksFilters] = useState({
    ...
    const [candidateTasks, setCandidateTasks] = useState([
        {
            ...
            type: "Call",
            sub_type: "Follow-Up",
            start_date_time: "10-02-2025 10:00 AM", // dd-mm-yyyy format
            priority: "High",
            subject: "Discuss Project Deliverables",
            status: "Pending",
            ...
            groups: "Development",
            create_date: "01-02-2025", // dd-mm-yyyy format
        ...
        },
        {
            ...
            type: "Meeting",
            sub_type: "Initial",
            start_date_time: "15-02-2025 02:00 PM", // dd-mm-yyyy format
            priority: "Medium",
            ...
            categories: "Design",
            groups: "UX Team",
            create_date: "05-02-2025", // dd-mm-yyyy format
            edit_date: "07-02-2025", // dd-mm-yyyy format
            created_by: "Delivery Manager",
        },
        {
            id: 3,
            type: "Call",
            sub_type: "Follow-up",
            start_date_time: "16-02-2025 10:00 AM", // dd-mm-yyyy format
            priority: "High",
        ...
        },
        {
            ...
            type: "Meeting",
            sub_type: "Final",
            start_date_time: "20-02-2025 03:00 PM", // dd-mm-yyyy format
            priority: "Low",
            subject: "Release Handover",
            status: "Scheduled",
            ...
            categories: "Review",
            groups: "QA Team",
            create_date: "08-02-2025", // dd-mm-yyyy format
            edit_date: "10-02-2025", // dd-mm-yyyy format
        ...
        },
        {
            ...
            type: "Call",
            sub_type: "Check-in",
            start_date_time: "18-02-2025 01:00 PM", // dd-mm-yyyy format
            priority: "Medium",
            ...
            groups: "AI Team",
            create_date: "09-02-2025", // dd-mm-yyyy format
            edit_date: "11-02-2025", // dd-mm-yyyy format
        ...
        },
        {
            ...
            type: "Call",
            sub_type: "Initial",
            start_date_time: "20-02-2025 02:30 PM", // dd-mm-yyyy format
            priority: "Medium",
            subject: "Offshore Team Onboarding",
            status: "Scheduled",
        ...
        },
        {
            ...
            type: "Call",
            sub_type: "Follow-up",
            start_date_time: "17-02-2025 03:00 PM", // dd-mm-yyyy format
            priority: "High",
        ...
        },
        {
            ...
            type: "Call",
            sub_type: "Check-in",
            start_date_time: "15-02-2025 11:00 AM", // dd-mm-yyyy format
            priority: "Low",
        ...
        },
        {
            ...
            type: "Call",
            sub_type: "Follow-up",
            start_date_time: "19-02-2025 09:30 AM", // dd-mm-yyyy format
            priority: "High",
            subject: "Microservices Architecture Implementation",
            status: "Scheduled",
        ...
        },
        {
            ...
            create_date: "05-02-2025", // dd-mm-yyyy format
            edit_date: "06-02-2025", // dd-mm-yyyy format
            created_by: "Business Head",
        },
        {
            id: 11,
            type: "Call",
            sub_type: "Check-in",
            start_date_time: "21-02-2025 04:00 PM", // dd-mm-yyyy format
            priority: "Low",
            subject: "ML Model Deployment Plan",
            status: "Scheduled",
    ...
    const [selectedCandidateTasks, setSelectedCandidateTasks] = useState([]);
    ...
    const deleteCandidate = (candidate) => {
        let _candidates = [...candidateTasks];
        _candidates = _candidates.filter((c) => c.id !== candidate.id);
        setCandidateTasks(_candidates); // Update the candidate data state
        toast.current.show({ severity: 'error', summary: 'Task Deleted', detail: `Deleted ${candidate.type}` });
    };
                        ...
                        <Row className="justify-content-between ac-items">
                            <Col xxl={9} xl={12} lg={12} md={12} sm={12}>
                                <span className="addcan-ac">
                                    ...
                                    {selectedCandidateTasks.length > 0 ?
                                        ...
                                        <span className="action-icons me-2">
                                            ...
                                            >
                                                <i className="pi pi-user"></i> {selectedCandidateTasks.length} Selected
                                            </button>
                            ...
                            <Col xxl={3} xl={12} lg={12} sm={12}>
                                <div className="clr-icons">
                                    {selectedCandidateTasks.length > 0 ? <NotesCandidate /> : <Notes />}
                            ...
                            <Col lg={12}>
                                ...
                                <div className="card1 mt-4 mb-4 actjobsumtable">
                                    <DataTable
                                        ...
                                        emptyMessage="No candidate tasks found."
                                        selection={selectedCandidateTasks}
                                        onSelectionChange={(e) => setSelectedCandidateTasks(e.value)}
...
export default CandidatesTaskList;
