...
const CandidatesPool = () => {
    ...
    // Datatable fields
    const [candidatesPoolFilters, setCandidatesPoolFilters] = useState({
        global: { value: null, matchMode: FilterMatchMode.CONTAINS },
        skill_type: { value: null, matchMode: FilterMatchMode.STARTS_WITH },
    ...
    const [candidatesPool, setCandidatesPool] = useState([
        {
            ...
            primary_skills: "React, JavaScript",
            company: "Tech Innovators",
            email_primary: "rahul.sharma@example.com",
            mobile_phone: "+91 98765 43210",
            city: "Mumbai",
            status: "Active",
            employee_type: "Full-Time",
            relocation: "No",
            availability_date: "10/03/2025",
        ...
        },
        {
            ...
            email_primary: "priya.patel@example.com",
            mobile_phone: "+91 87654 32109",
            city: "Bangalore",
            status: "Active",
            employee_type: "Contract",
            relocation: "Yes",
            availability_date: "01/04/2025",
            categories: "Design",
            groups: "Design Team",
        ...
        },
        {
            ...
            primary_skills: "Illustrator, Photoshop",
            company: "Design Works",
            email_primary: "ananya.gupta@example.com",
            mobile_phone: "+91 76543 21098",
            city: "Delhi",
            status: "Active",
            employee_type: "Full-Time",
            relocation: "No",
            availability_date: "15/03/2025",
            categories: "Design",
            groups: "Creative Team",
            create_date: "12/01/2025",
            edit_date: "16/01/2025",
            created_by: "Manager"
        },
        {
            skill_type: "Design",
            ...
            email_primary: "arjun.singh@example.com",
        ...
        },
        {
            ...
            email_primary: "sanya.verma@example.com",
        ...
        },
        {
            ...
            primary_skills: "HTML, CSS, Figma",
            company: "Web Creators",
            email_primary: "vihaan.joshi@example.com",
        ...
        },
        {
            ...
            primary_skills: "Adobe XD, Figma",
            company: "Pixel Creations",
            email_primary: "ishita.malhotra@example.com",
            mobile_phone: "+91 32109 87654",
            city: "Kolkata",
            status: "Active",
            employee_type: "Contract",
            relocation: "Yes",
            availability_date: "15/08/2025",
            categories: "Design",
            groups: "Design Team",
        ...
        },
        {
            ...
            primary_skills: "Wireframing, Figma",
            company: "Digital Studios",
            email_primary: "rohan.mehta@example.com",
        ...
        },
        {
            ...
            last_name: "Shah",
            job_title: "UI/UX Designer",
            primary_skills: "Sketch, InVision",
            company: "Creative Solutions",
            email_primary: "aarav.shah@example.com",
        ...
        },
        {
            ...
            email_primary: "aditi.reddy@example.com",
            mobile_phone: "+91 98765 43210",
            city: "Lucknow",
            status: "Active",
            employee_type: "Full-Time",
            ...
            categories: "Design",
            groups: "Creative Team",
            create_date: "28/01/2025",
            edit_date: "01/02/2025",
            created_by: "Manager"
        },
        {
            skill_type: "Design",
            ...
            email_primary: "kabir.kumar@example.com",
            mobile_phone: "+91 87654 32109",
            city: "Chandigarh",
            status: "Active",
            employee_type: "Contract",
    ...
    const [selectedCandidatesPool, setSelectedCandidatesPool] = useState([]);
    ...
    const deleteCandidate = (candidate) => {
        let _candidates = [...candidatesPool];
        _candidates = _candidates.filter((c) => c.id !== candidate.id);
        setCandidatesPool(_candidates); // Update the candidate data state
    ...
    const handleClearSearchPool = () => {
        setCandidatesPoolFilters({
            skill_type: { value: " " },
            first_name: { value: " " },
            last_name: { value: " " },
            job_title: { value: " " },
                        ...
                        <Row className="justify-content-between ac-items">
                            <Col xxl={9} xl={12} lg={12} md={12} sm={12}>
                                <span className="addcan-ac">
                                    ...
                                    {selectedCandidatesPool.length > 0 ?
                                        ...
                                        <span className="action-icons me-2">
                                            ...
                                            >
                                                <i className="pi pi-user"></i> {selectedCandidatesPool.length} Selected
                                            </button>
                            ...
                            <Col xxl={3} xl={12} lg={12} sm={12}>
                                <div className="clr-icons">
                                    {selectedCandidatesPool.length > 0 ? <NotesCandidate /> : <Notes />}
                                    ...
                                    <button
                                        type="button"
                                        className="btn btn-secondary icons-btn" Tooltip="Clear Search" onClick={handleClearSearchPool}
                                    >
                            ...
                            <Col lg={12}>
                                ...
                                <div className="card1 mt-4 mb-4 actjobsumtable">
                                    <DataTable
                                        ...
                                        emptyMessage="No candidates found in the pool."
                                        selection={selectedCandidatesPool}
                                        onSelectionChange={(e) => setSelectedCandidatesPool(e.value)}
                                    ...
                                    >
                                        ...
                                        <Column field="skill_type" header="Skill Type" sortable filter style={{ minWidth: "12rem" }} />
