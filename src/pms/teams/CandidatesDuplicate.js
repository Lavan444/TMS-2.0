...
const CandidatesDuplicate = () => {

    // Datatable fields
    const [candidatesDuplicateFilters, setCandidatesDuplicateFilters] = useState({
    ...
    const [candidatesDuplicate, setCandidatesDuplicate] = useState([
        {
            id: 1,
            first_name: "Gracy",
            last_name: "Lal",
            ...
            email_primary: "gracy.lal@example.com",
        ...
        },
        {
            ...
            email_primary: "harsha.kapoor@example.com",
            mobile_phone: "+91-8765432109",
            city: "Bengaluru",
            categories: "Product",
            groups: "Product Team",
        ...
        },
        {
            ...
            company: "Tech Innovations",
            job_title: "Product Manager",
            primary_skills: "Product Development, Agile",
            email_primary: "eshan.trivedi@example.com",
            mobile_phone: "+91-7654321098",
            city: "Hyderabad",
            categories: "Product",
            groups: "Product Team",
        ...
        },
        {
            ...
            job_title: "Product Manager",
            primary_skills: "Scrum, Roadmap Planning",
            email_primary: "saanvi.mishra@example.com",
        ...
        },
        {
            ...
            primary_skills: "Product Strategy, Agile",
            email_primary: "jayant.rao@example.com",
            mobile_phone: "+91-7654321987",
            city: "Delhi",
            categories: "Product",
            groups: "Product Strategy Team",
            create_date: "18-01-2025",
            edit_date: "21-01-2025",
            created_by: "Manager",
        },
        {
            id: 6,
            ...
            job_title: "Product Manager",
            primary_skills: "Agile, Scrum Master",
            email_primary: "laksh.sharma@example.com",
            mobile_phone: "+91-9123456789",
            city: "Chennai",
            categories: "Product",
            groups: "Product Team",
            create_date: "22-01-2025",
            edit_date: "24-01-2025",
            created_by: "Manager",
        },
        {
            id: 7,
            ...
            job_title: "Product Manager",
            primary_skills: "Agile, Scrum, Product Lifecycle",
            email_primary: "oviya.menon@example.com",
            mobile_phone: "+91-8123456789",
            city: "Kolkata",
            categories: "Product",
            groups: "Product Team",
            create_date: "19-01-2025",
            edit_date: "23-01-2025",
            created_by: "Manager",
        },
        {
            id: 8,
            ...
            company: "Future Tech",
            job_title: "Product Manager",
            primary_skills: "Agile, Market Research",
            email_primary: "aryan.verma@example.com",
            mobile_phone: "+91-9654321987",
            city: "Ahmedabad",
            categories: "Product",
            groups: "Product Team",
        ...
        },
        {
            ...
            job_title: "Product Manager",
            primary_skills: "Scrum, User-Centered Design",
            email_primary: "mihir.bansal@example.com",
            mobile_phone: "+91-9786543210",
            city: "Lucknow",
            categories: "Product",
            groups: "Product Team",
            create_date: "11-01-2025",
        ...
        },
        {
            ...
            job_title: "Product Manager",
            primary_skills: "Agile, Product Launch",
            email_primary: "charvi.deshmukh@example.com",
            mobile_phone: "+91-8456123789",
            city: "Jaipur",
            categories: "Product",
            groups: "Product Team",
            create_date: "17-01-2025",
            edit_date: "19-01-2025",
            created_by: "Manager",
        },
        {
            id: 11,
            ...
            job_title: "Senior Product Manager",
            primary_skills: "Agile, Strategic Planning",
            email_primary: "eshan.tiwari@example.com",
            mobile_phone: "+91-9123678541",
            city: "Indore",
            categories: "Product",
            groups: "Product Team",
            create_date: "15-01-2025",
    ...
    const [selectedCandidatesDuplicate, setSelectedCandidatesDuplicate] = useState([]);
    ...
    const deleteCandidate = (candidate) => {
        let _candidates = [...candidatesDuplicate];
        _candidates = _candidates.filter((c) => c.id !== candidate.id);
        setCandidatesDuplicate(_candidates); // Update the candidate data state
        toast.current.show({ severity: 'error', summary: 'Duplicate Candidate Deleted', detail: `Deleted ${candidate.first_name}` });
    };
    ...
    const handleClearSearchDuplicate = () => {
        setCandidatesDuplicateFilters({
            first_name: { value: " " },
            last_name: { value: " " },
            company: { value: " " },
            job_title: { value: " " },
                        ...
                        <Row className="justify-content-between ac-items">
                            <Col xxl={9} xl={12} lg={12} md={12} sm={12}>
                                <span className="addcan-ac">
                                    ...
                                    {selectedCandidatesDuplicate.length > 0 ?
                                        ...
                                        <span className="action-icons me-2">
                                            ...
                                            >
                                                <i className="pi pi-user"></i> {selectedCandidatesDuplicate.length} Selected
                                            </button>
                            ...
                            <Col xxl={3} xl={12} lg={12} sm={12}>
                                <div className="clr-icons">
                                    {selectedCandidatesDuplicate.length > 0 ? <NotesCandidate /> : <Notes />}
                                    ...
                                    <button
                                        type="button"
                                        className="btn btn-secondary icons-btn" Tooltip="Clear Search" onClick={handleClearSearchDuplicate}
                                    >
                            ...
                            <Col lg={12}>
                                ...
                                <div className="card1 mt-4 mb-4 actjobsumtable">
                                    <DataTable
                                        ...
                                        filters={candidatesDuplicateFilters}
                                        filterDisplay="row"
                                        globalFilterFields={[
                                            "first_name",
                                            "last_name",
                                        ...
                                        selection={selectedCandidatesDuplicate}
                                        onSelectionChange={(e) => setSelectedCandidatesDuplicate(e.value)}
...
export default CandidatesDuplicate;
