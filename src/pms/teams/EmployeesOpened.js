...
const EmployeesOpened = () => {

    // Datatable fields

    const [candidatesOpenedFilters, setCandidatesOpenedFilters] = useState({
    ...
    const [candidatesOpened, setCandidatesOpened] = useState([
        {
            id: 1, // Unique ID
            first_name: "Chetan",
            last_name: "Desai",
            ...
            primary_skills: "Node.js, SQL",
            email_primary: "chetan.desai@techmahindra.com",
            mobile_phone: "+91 98765 43210",
            city: "Mumbai",
            status: "Active",
            employee_type: "Full-Time",
            relocation: "Yes",
            availability_date: "28-02-2025", // dd-mm-yyyy
            categories: "Development",
            groups: "Backend Team",
            create_date: "02-02-2025", // dd-mm-yyyy
            edit_date: "05-02-2025", // dd-mm-yyyy
            created_by: "Admin",
        },
        {
            id: 2,
            ...
            email_primary: "dinesh.kumar@infosys.com",
            mobile_phone: "+91 87654 32109",
            city: "Bengaluru",
            status: "On Hold",
            employee_type: "Contract",
            relocation: "No",
            availability_date: "01-04-2025", // dd-mm-yyyy
            categories: "Development",
            groups: "Full Stack Team",
            create_date: "04-02-2025", // dd-mm-yyyy
            edit_date: "06-02-2025", // dd-mm-yyyy
            created_by: "Manager",
        },
        {
            id: 3,
            ...
            email_primary: "ekta.mishra@wipro.com",
            mobile_phone: "+91 76543 21098",
            city: "Pune",
            status: "Active",
            employee_type: "Full-Time",
            relocation: "Yes",
            availability_date: "15-03-2025", // dd-mm-yyyy
            categories: "Development",
            groups: "Backend Team",
            create_date: "04-02-2025", // dd-mm-yyyy
            edit_date: "06-02-2025", // dd-mm-yyyy
        ...
        },
        {
            ...
            primary_skills: "Vue.js, TypeScript",
            email_primary: "bhuvan.gupta@tcs.com",
            mobile_phone: "+91 65432 10987",
            city: "Hyderabad",
            status: "On Hold",
            employee_type: "Contract",
            relocation: "No",
            availability_date: "10-04-2025", // dd-mm-yyyy
            categories: "Development",
        ...
        },
        {
            ...
            primary_skills: "Figma, Adobe XD",
            email_primary: "meera.hegde@hcl.com",
            mobile_phone: "+91 54321 09876",
            city: "Chennai",
            status: "Pending",
            employee_type: "Contract",
            relocation: "Yes",
            availability_date: "25-03-2025", // dd-mm-yyyy
            categories: "Design",
            groups: "Design Team",
            create_date: "04-02-2025", // dd-mm-yyyy
            edit_date: "06-02-2025", // dd-mm-yyyy
            created_by: "Creative Manager",
        },
        {
            id: 6,
            first_name: "Lokesh",
            ...
            email_primary: "lokesh.nair@techmahindra.com",
            mobile_phone: "+91 43210 98765",
            city: "Noida",
            status: "Active",
            employee_type: "Full-Time",
            relocation: "No",
            availability_date: "01-03-2025", // dd-mm-yyyy
        ...
        },
        {
            ...
            primary_skills: "Flutter, Swift",
            email_primary: "sanjana.lal@infosys.com",
            mobile_phone: "+91 32109 87654",
            city: "Bengaluru",
            status: "On Hold",
            employee_type: "Contract",
            relocation: "No",
            availability_date: "05-04-2025", // dd-mm-yyyy
            categories: "Development",
            groups: "Mobile Team",
            create_date: "04-02-2025", // dd-mm-yyyy
            edit_date: "06-02-2025", // dd-mm-yyyy
        ...
        },
        {
            ...
            primary_skills: "Selenium, Cypress",
            email_primary: "jai.wadhwa@wipro.com",
            mobile_phone: "+91 21098 76543",
            city: "Kolkata",
            status: "Active",
            employee_type: "Full-Time",
            relocation: "Yes",
            availability_date: "20-03-2025", // dd-mm-yyyy
        ...
        },
        {
            ...
            primary_skills: "AWS, GCP",
            email_primary: "esha.kashyap@tcs.com",
            mobile_phone: "+91 10987 65432",
            city: "Delhi",
            status: "Pending",
            employee_type: "Contract",
            relocation: "No",
            availability_date: "15-04-2025", // dd-mm-yyyy
            categories: "IT",
            groups: "Cloud Team",
            create_date: "04-02-2025", // dd-mm-yyyy
            edit_date: "06-02-2025", // dd-mm-yyyy
        ...
        },
        {
            ...
            primary_skills: "MySQL, PostgreSQL",
            email_primary: "lakshay.bhatia@hcl.com",
            mobile_phone: "+91 09876 54321",
            city: "Ahmedabad",
            status: "On Hold",
            employee_type: "Contract",
            relocation: "Yes",
            availability_date: "20-04-2025", // dd-mm-yyyy
        ...
        },
        {
            ...
            primary_skills: "TensorFlow, PyTorch",
            email_primary: "ojaswini.tiwari@techmahindra.com",
            mobile_phone: "+91 89012 34567",
            city: "Pune",
            status: "Active",
            employee_type: "Full-Time",
            relocation: "No",
            availability_date: "10-03-2025", // dd-mm-yyyy
    ...
    const [selectedCandidatesOpened, setSelectedCandidatesOpened] = useState([]);
    ...
    const deleteCandidate = (candidate) => {
        let _candidates = [...candidatesOpened];
        _candidates = _candidates.filter((c) => c.id !== candidate.id);
        setCandidatesOpened(_candidates); // Update the candidate data state
    ...
    const handleClearSearchOpened = () => {
        setCandidatesOpenedFilters({
            first_name: { value: " " },
            last_name: { value: " " },
            company: { value: " " },
            job_title: { value: " " },
                        ...
                        <Row className="justify-content-between ac-items">
                            <Col xxl={9} xl={12} lg={12} md={12} sm={12}>
                                <span className="addcan-ac">
                                    ...
                                    {selectedCandidatesOpened.length > 0 ?
                                        ...
                                        <span className="action-icons me-2">
                                            ...
                                            >
                                                <i className="pi pi-user"></i> {selectedCandidatesOpened.length} Selected
                                            </button>
                            ...
                            <Col xxl={3} xl={12} lg={12} sm={12}>
                                <div className="clr-icons">
                                    {selectedCandidatesOpened.length > 0 ? <NotesCandidate /> : <Notes />}
                                    <ImportResumeCan />
                                    <Export />

                                    <button
                                        type="button"
                                        className="btn btn-secondary icons-btn" Tooltip="Clear Search" onClick={handleClearSearchOpened}
                                    >
                            ...
                            <Col lg={12}>
                                ...
                                <div className="card1 mt-4 mb-4 actjobsumtable">
                                    <DataTable
                                        ...
                                        filters={candidatesOpenedFilters}
                                        filterDisplay="row"
                                        globalFilterFields={[
                                            "first_name",
                                            "last_name",
                                        ...
                                        emptyMessage="No candidates opened found."
                                        selection={selectedCandidatesOpened}
                                        onSelectionChange={(e) => setSelectedCandidatesOpened(e.value)}
                                    ...
                                    >
                                        ...
                                        <Column field="email_primary" header="Email (Primary)" sortable filter style={{ minWidth: "12rem" }} />
...
export default EmployeesOpened;
