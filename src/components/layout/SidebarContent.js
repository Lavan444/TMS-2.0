      ...
      subItems: [
        {
          ...
          subItems: [
            ...
            { id: 'my-active-jobs ', title: 'My Active', },
            { id: 'assigned-to-me', title: 'Assigned to Me', route: '/assignedtome-jobs', disabled: true },
            { id: 'all-closed', title: 'All Closed', route: '/joballclosed-jobs' , disabled: true},
            { id: 'archived-jobs', title: 'Archived', route: '/jobarchived-jobs', disabled: true }
          ]
        },
        {
          id: 'work-type',
