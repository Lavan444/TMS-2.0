...
const Footer = ({ callBack }) => {
  ...
  const dummyData = [
    { id: 1, name: "Work Type Code" },
    { id: 2, name: "Work Type" },
    { id: 3, name: "Project Name" },
    { id: 4, name: "Module Name" },
    { id: 5, name: "Status" },
    { id: 6, name: "Primary Skills" },
    { id: 7, name: "Summary" },
    { id: 8, name: "Created By" },
    { id: 9, name: "Assigned By" },
    { id: 10, name: "Assigned To" },
    { id: 11, name: "Project Manager" },
    { id: 12, name: "Watchers" },
    { id: 13, name: "Start Date" },
    { id: 14, name: "Work Hours (in hours)" },
    { id: 15, name: "End Date" },
    { id: 16, name: "Actual End Date" },
    { id: 17, name: "Status" },
    { id: 18, name: "Priority" },
    { id: 19, name: "Approval Status" },
